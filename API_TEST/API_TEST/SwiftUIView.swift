...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///以下のテキスト表示しているコードには画面遷移できるが、４０行目以降のARviewに遷移するとAR画面が表示されない。
import SwiftUI
import RealityKit
...
struct SwiftUIView: View {
    ...
    var test: String = String(describing: base64ToFront)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////上記10行目以降をテキスト表示しているコードには画面遷移できるが、４０行目以降のARviewに遷移するとAR画面が表示されない。
//import SwiftUI
//import RealityKit
//
//
